...
class PatientDetailReciption extends StatefulWidget {
  const PatientDetailReciption({ Key? key }) : super(key: key);

  @override
  _PatientDetailReciptionState createState() => _PatientDetailReciptionState();
}

class _PatientDetailReciptionState extends State<PatientDetailReciption> {
   List doctors=[{
