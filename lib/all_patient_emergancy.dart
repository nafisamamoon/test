...
import 'package:photo/patient_detail_emergancy.dart';
class AllPatientEmergancy extends StatefulWidget {
  const AllPatientEmergancy({ Key? key }) : super(key: key);

  @override
  _AllPatientEmergancyState createState() => _AllPatientEmergancyState();
}

class _AllPatientEmergancyState extends State<AllPatientEmergancy> {
   List doctors=[{
    'name':'nafisa',
    'img':'asset/u.jpg'
    },
...
body: ListView.builder(
   ...
   Navigator.of(context).push(MaterialPageRoute(builder: (context)=>PatientDetailEmergancy()));
    },
